                ...
                <form id="formProduto">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="quantidadeProduto" required min="0" value="0" name="quantidade">
                        </div>
                        
                        <div class="form-group">
                            <label for="estoqueMinimo">Estoque Mínimo *</label>
                            <input type="number" id="estoqueMinimo" required min="0" value="0" name="estoque_minimo">
                        </div>

                        <div class="form-group">
                            <label for="precoCusto">Preço</label>
                            <input type="number" id="precoCusto" step="0.01" min="0" value="0" placeholder="0.00" name="preco">
                        </div>
