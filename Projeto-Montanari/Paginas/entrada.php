    ...
    <div class="auth-container">
        <div class="auth-card">
            ...
            <div id="loginForm" class="form-container active">
                ...
                <form id="formLogin" method="post" action="Projeto-Montanari/Back-End/entrar.php">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" id="loginSenha" placeholder="••••••••" name="nome" required>
                    </div>
            ...
            <div id="cadastroForm" class="form-container">
                ...
                <form id="formCadastro" method="post" action="/Projeto-Montanari/Back-End/cadastro.php">
                    <div class="form-grid">
                        <div class="form-group">
