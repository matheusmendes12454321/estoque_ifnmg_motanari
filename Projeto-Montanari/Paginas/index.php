<?php
// Configurações iniciais e verificar se ja tem usuario
session_start();
    ...
    <nav class="navbar">
        <div class="nav-container">
            ...
            <div class="nav-links">
                ...
                <a href="entrada.php" class="btn-login">Entrar</a>
            </div>
        </div>
    </nav>
    ...
    <section class="hero">
        ...
        <div class="hero-content">
            ...
            <div class="hero-buttons">
                <a href="../Paginas/entrada.php" class="btn btn-primary">
                    Comece Já
    ...
    <section class="cta">
        <div class="cta-container">
            <div class="cta-content">
                ...
                <a href="../Paginas/entrada.php" class="btn btn-primary btn-large">
